                        ...
                        >
                            <Link to={`/project/${project.slug}`} className="block relative aspect-[21/9] overflow-hidden rounded-3xl">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                                    ...
                                    <div className="mt-8 px-8 py-3 bg-white text-black rounded-full font-medium opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                                        View Mission
                                    </div>
                                </div>
                            </Link>
