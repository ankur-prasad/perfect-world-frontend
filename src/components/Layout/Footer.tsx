...
const Footer: FC<FooterProps> = ({
  ...
  usefulLinks = [
    ...
    { label: "Founder's Story", href: '/founders-story', external: false },
  ...
  return (
    <footer className={cn('bg-gradient-to-br from-black via-black/95 to-black/90 text-white relative', className)} style={{ zIndex: 10, pointerEvents: 'auto' }} {...props}>
      <div className="container mx-auto max-w-7xl relative" style={{ zIndex: 10 }}>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 md:gap-10 lg:gap-12 relative" style={{ paddingLeft: '80px', paddingRight: '0px', paddingTop: '100px', paddingBottom: '80px', zIndex: 10 }}>
          {/* Company Info - About */}
        ...
        {/* Footer Bottom */}
        <div style={{ paddingLeft: '80px', paddingRight: '80px', paddingTop: '32px', paddingBottom: '40px' }}>
